...
echo "Username or Password is invalid. <br /><br /><a href='index.php'>Back to the login page</a>";
}
else
{
	// Check database if username and password exist
	$sql = "select username,password from accountinfo where password='$pass' AND username='$user'";
