...
<div class="row">
	...
	<div class="col-md-7">
		...
		$getpost = "SELECT * FROM posts WHERE post_tags LIKE '%$searchresult%' ORDER BY date_published DESC LIMIT $start_from, 5";
		$result1 = $conn->query($getpost);

		$countdata = "SELECT COUNT(post_tags) FROM posts WHERE post_tags LIKE '%$searchresult%'";
		...
		if ($result1->num_rows > 0) {
			...
			for ($i=1; $i<=$total_pages; $i++) {
				echo "<a href='tag_scan_active.php?page=".$i."&term=$searchresult#$i' id='".$i."'>".$i."</a> ";
			};
