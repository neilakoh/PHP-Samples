...
if(isset($_POST['submit']) && $user=="" || $pass==""){
	$msg = "<div class='sidebarcontainer' id='recent_post'>
	...
	<p class='processStats'>Username or Password is invalid!!<br /><a href='login.php?id=$passid&title=$passtitle' class='navbar-btn btn-danger btn pull-left'>Back to Login Page</a></p>
	</div></div>";
}
else
{
// Check database if username and password exist
$sql = "select username,password from user_account where password='$pass' AND username='$user'";
...
if ($result->num_rows > 0) {
	...
	header("location: view_post_active.php?id=$passid&title=$passtitle");
} 
}else {
	$msg = "<div class='sidebarcontainer' id='recent_post'>
	<div class='sidebar_title' style='font-size:40px;'>
	<img src='images/icons/error.png' style='position: relative; top: -5px;'> Error!</div>
	<div class='widget' style='height:115px; padding:10px; padding-top:20px; font-family: 'Lobster', cursive;'>
	<p class='processStats'>No user found!!<br /><a href='user_login.php' class='navbar-btn btn-danger btn pull-left'>Back to Login Page</a></p>
	</div></div>";
	}
}
?>
