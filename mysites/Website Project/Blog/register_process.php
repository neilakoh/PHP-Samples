...
<div class="row">
	...
	<div class="col-md-7">
		<div class="contentarea" id="recent_post">
				<!--<div class="sidebar_title" style="font-size:40px;"><img src="images/icons/success.png" style="position: relative; top: -5px;"> Success!</div>-->
				<div class="widget" style="padding:10px; padding-top:20px; font-family: 'Lobster', cursive;">
				
					<?php
						
					
						if(isset($_POST['submit']) || $email=="" || $user=="" || $pass=="" || $confpass=="" || $captcha==""){
							echo "<div class='sidebarcontainer' id='recent_post'>
							<div class='sidebar_title' style='font-size:40px;'>
							<img src='images/icons/error.png' style='position: relative; top: -5px;'> Warning!</div>
							<div class='widget' style='height:115px; padding:10px; padding-top:20px; font-family: 'Lobster', cursive;'>
							<p class='processStats'>Please fill out all the boxes! <br /><a href='user_register.php' class='navbar-btn btn-danger btn pull-left'>Back</a></p>
							</div></div>";
							...
							<img src='images/icons/error.png' style='position: relative; top: -5px;'> Warning!</div>
							<div class='widget' style='height:115px; padding:10px; padding-top:20px; font-family: 'Lobster', cursive;'>
							<p class='processStats'>Your Password Didn't match!! <br /><a href='user_register.php' class='navbar-btn btn-danger btn pull-left'>Back</a></p>
							</div></div>";
							...
							<img src='images/icons/error.png' style='position: relative; top: -5px;'> Warning!</div>
							<div class='widget' style='height:115px; padding:10px; padding-top:20px; font-family: 'Lobster', cursive;'>
							<p class='processStats'>The email you entered is not valid!! <br /><a href='user_register.php' class='navbar-btn btn-danger btn pull-left'>Back</a></p>
							</div></div>";
							...
							<img src='images/icons/error.png' style='position: relative; top: -5px;'> Warning!</div>
							<div class='widget' style='height:115px; padding:10px; padding-top:20px; font-family: 'Lobster', cursive;'>
							<p class='processStats'>Wrong Security code entered!! <br /><a href='user_register.php' class='navbar-btn btn-danger btn pull-left'>Back</a></p>
							</div></div>";
						} else {
							$sql = "INSERT INTO user_account (username, password, email, userImg) VALUES ('$user', '$pass', '$email', 'default.jpg')";
							
							if ($conn->query($sql) === TRUE) {
								echo "<div class='sidebarcontainer' id='recent_post'>
								<div class='sidebar_title' style='font-size:40px;'>
								<img src='images/icons/success.png' style='position: relative; top: -5px;'> Success!</div>
								<div class='widget' style='height:115px; padding:10px; padding-top:20px; font-family: 'Lobster', cursive;'>
								<p class='processStats'>Account Successfully Created!! You can login now by clicking the link below. <br /><a href='user_login.php' class='navbar-btn btn-danger btn pull-left'>Login Now</a></p>
								</div></div>";
								die();
							} else {
