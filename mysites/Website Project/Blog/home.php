...
<link href="../resources/fontawsome/font-awesome-4.4.0/css/font-awesome.min.css" rel="stylesheet">
		...
		if ($result1->num_rows > 0) {
			while($row = $result1->fetch_assoc()) {
				...
				if (strlen($string) > 300) {
					...
					$string = substr($stringCut, 0, strrpos($stringCut, ' '))."... <a href='view_post.php?id=$postid&title=$posttitle' class='tinylinks' style='text-decoration: none; padding-top: 2px; padding-bottom: 2px; padding-left: 5px; padding-right: 5px; background: #005c5c; color:#ffffff; border-radius: 2px;'>Read More</a>";
			...
			if($passid > 1) {
				echo "<a href='index.php?page=".$backpage."#$backpage' id='".$backpage."'>Previous Page</a> ";
			}
			...
			echo "<a href='index.php?page=".$nextpage."#$nextpage' id='".$nextpage."'>Next Page</a>";
			}
