...
<div class="row">
	...
	<div class="col-md-7">
		...
		if ($result1->num_rows > 0) {
			...
			if($passid > 1) {
				echo "<a href='search_scan_active.php?page=".$backpage."&term=$pterm#$backpage' id='".$backpage."'>Previous Page</a> ";
			}
			
			for ($i=1; $i<=$total_pages; $i++) {
				echo "<a href='search_scan_active.php?page=".$i."&term=$pterm#$i' id='".$i."'>".$i."</a> ";
				$num[] = $i;
				$maxval = count($num);
			};
			
			if($passid > 0 && $passid < $maxval) {
			echo "<a href='search_scan_active.php?page=".$nextpage."&term=$pterm#$nextpage' id='".$nextpage."'>Next Page</a>";
			}
