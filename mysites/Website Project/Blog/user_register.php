...
<!--This will filter to only accept letters and numbers in the username-->
...
<div class="row">
	...
	<div class="col-md-7">
		<div class="sidebarcontainer" id="recent_post">
				<div class="sidebar_title" style="font-size:40px;">Register</div>
				<div class="widget" style="padding:10px; padding-top:20px; font-family: 'Lobster', cursive;">
				
					<form action="register_process.php" onsubmit="return validate(this);" method="post">
						<div class="rows" id="username">
							<div class="cols" id="label">Username :</div>
							<div class="cols" id="box"><input type="text" name="user" id="user" class="inputs" maxlength="12" value="<?php $user?>"></div>
						</div>
						<div class="rows" id="password">
							<div class="cols" id="label">Password :</div>
							<div class="cols" id="box"><input type="password" name="pass" id="pass" class="inputs" maxlength="8" value="<?php $pass?>"></div>
						</div>
						<div class="rows" id="repeatpass">
							<div class="cols" id="label">Confirm Password :</div>
							<div class="cols" id="box"><input type="password" name="confpass" id="pass" class="inputs" maxlength="8" value="<?php $confpass?>"></div>
						</div>
						<div class="rows" id="email">
							<div class="cols" id="label">E-Mail :</div>
							<div class="cols" id="box"><input type="text" name="email" id="email" class="inputs" maxlength="30" value="<?php $email?>"></div>
						</div>
						<div class="rows" id="captchaImg">
							<div class="cols" id="label"></div>
							<div class="cols" id="box"><img src="captcha.php" style="border: 1px solid;" width="200" height="45"></div>
						</div>
						<div class="rows" id="captcha">
							<div class="cols" id="label">Enter the code :</div>
							<div class="cols" id="box"><input type="text" name="captcha" id="captcha" class="inputs" maxlength="10" value="<?php $captcha?>"></div>
						</div>
						<div class="cols" id="label"></div>
						<div class="cols" id="box"><input type="submit" name="register" id="register" value="Register Now"></div>
					</form>
